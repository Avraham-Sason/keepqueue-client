        ...
        <SidebarContext.Provider value={contextValue} >
            <TooltipProvider delayDuration={0}>
                <div
                    ...
                    className={cn("w-screen min-h-dvh group/sidebar-wrapper flex  has-[[data-variant=inset]]:bg-sidebar", className)}
                    ref={ref}
                    {...props}
                >
                    {children}
...
const SidebarTrigger = React.forwardRef<React.ElementRef<typeof Button>, React.ComponentProps<typeof Button> & { isClose?: boolean }>(
    ({ className, onClick, isClose = false, ...props }, ref) => {
        ...
        return (
            <Button
                ...
                {...props}
            >
                {isClose ? <X className="size-6" /> : <PanelLeft className="size-4" />}
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"main">>(({ className, ...props }, ref) => {
    return (
        <main
            ref={ref}
            className={cn(
                "relative flex w-screen min-h-dvh flex-1 flex-col bg-background",
